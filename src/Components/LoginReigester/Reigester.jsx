...
//  It is a library which is used to make 
// requests to an API, return data from the API, and then do things with that data in our React application
...
class Reigester extends Component {
    ...
    //register user based on registration details via API   
    Reigester = (e) => {
        e.preventDefault();
        this.setState({ [e.target.name]: e.target.value });
        const Data = {
        ...
        return (
           <React.Fragment>
            ...
            <form className="form-Reigester">
                ...
                />
                <button  onClick={ this.Reigester }  className="btn btn-md btn-success btn-block" type="submit">Register</button>
            </form>
           </React.Fragment>
            );
    }
